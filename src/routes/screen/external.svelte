...
<div class="container-fluid text-center justify-content-center row" style="background-color: black;">
  <div class="text-center justify-content-center row">
      <div class="col-12">
          <br />
          <h1 class="text-uppercase" style="color: red; font-weight: 800;">{athlete.result.toFixed(2) || 0.0}</h1>
          <p class="float-right text-center align-self-end h2 font-weight-bolder p-4 mr-0" style="background-color: transparent; color: yellow; font-size: 50px;">1</p>
      </div>
  </div>
  <div class="p-3 row">
      <div class="col-5">
          <div class="justify-content-center text-center p-4 font-weight-bolder" style="background-color: yellow; color: red; height: 230px;">
              <h1 style="font-size: 130px; font-weight: 800;">{athlete.result.toFixed(2) || 0.0}</h1>
          </div>
      </div>
      <div class="justify-content-end text-center pt-4 text-white font-weight-bolder col-5">
          <span class="font-size-18">0.7 TECHNICAL</span>&nbsp;&nbsp;<span class="font-size-18">0.3 ATHLETIC</span>
      </div>
      <div class="col-2"></div>
  </div>
  <br />
  ...
  <div class="p-4 row">
      ...
      <div class="col-4">
          <div class="text-center">
              <img class="img-fluid" src={athlete.club.flag} alt="state-flag" width="300" />
          </div>
      </div>
      <div class="col-4">
...
{:else if show == "kata"}
  <div class="container mb-4 pb-4">
    <div class="row mt-5 text-center justify-content-center row" style="background-color: gray;">
      <div class="cell-12">
        <h1>{pool.poolName}</h1>
      </div>
    </div>
...
<div class="container pt-5">
  ...
  <div class="row">
    ...
    <div class="col-7">
      ...
      <h1>
        <img src={club.flag || "images/HAWKtm.png"} class="flag mr-3" alt="flag">
  ...
  <div class="mt-2">
    ...
    {#each judges as judge}
      <span id={"ap" + judge.id} class="s-h3 soft-border s-border">{judge.RESULT || ""}</span>
    {/each}
  ...
  <div class="row">
    <div class="col-12">
      <h1 class="text-right" style="color: whitesmoke;">{athlete.pool_entries.kata}</h1>
    </div>
  </div>
</div>
